...
let factData: [Fact] = [
    ...
    content: "Avocados are a nutrient-dense fruit that offers a wide range of health benefits. A single serving of avocado (approximately 50 grams or one-fourth of a whole avocado) provides a substantial amount of healthy fats, fiber, folate, niacin, vitamins C, B5, E, and K, potassium, and antioxidants"
    ),
    Fact(
